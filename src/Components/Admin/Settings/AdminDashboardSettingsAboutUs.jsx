...
const AdminDashboardSettingsAboutUs = () => {
  return (
    <>
        ...
        <div className="row">
          ...
          <AdminHeader/>
            ...
            <h2 className=''>About Us</h2>
             <p className='text-secondary mt-3' style={{fontSize:'21px'}}>Lorem ipsum dolor sit amet consectetur. Molestie turpis faucibus diam at mattis consequat. Et nunc felis tortor vestibulum est lacus ornare egestas. Ut tincidunt maecenas eget posuere sed. Ridiculus congue lectus est duis tellus sit. Nisl neque eget lectus sed tempor etiam adipiscing tristique. Et nisl odio sed blandit pellentesque feugiat ornare. Eget volutpat consectetur pellentesque lectus mi quis.</p>
...
export default AdminDashboardSettingsAboutUs